...
Behavior Lock: API MFA/license tests, node-agent license-pause tests, release manifest signature tests, license-server security scaffold tests, and client manifest schema tests were added or rerun before cleanup classification.
...
Passes Completed:
- Fallback-like code resolution gate - preserved grounded compatibility paths and closed unsafe public security scaffold default.
...
4. Test reinforcement - added regression coverage for MFA login challenge, local-license authority, durable license pause, Ed25519 manifest signature, disabled public scaffold, and manifest schema drift.
...
Remaining Risks:
- No new cleanup blockers found. Release signing private-key custody remains a deployment/process concern outside the public installer repository.
