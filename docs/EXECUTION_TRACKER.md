...
| PH-009 | Protocol-specific profile builders | NEXT | Builders for supported adapters produce valid payloads and port reservations, no raw JSON-only requirement | Not started |
