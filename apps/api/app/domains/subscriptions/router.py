        ...
        <div class="steps">
          ...
          <article class="step">
            ...
            <div>
              ...
              <div class="step-actions">
                <a class="button primary" href="{escaped_add_link}" data-client-link data-client="{html_escape(client_label, quote=True)}" data-raw-url="{escaped_raw}">
    ...
    (() => {{
      ...
      document.querySelectorAll('[data-client-link]').forEach((link) => {{
        link.addEventListener('click', async (event) => {{
          ...
          if (rawUrl && navigator.clipboard) {{
            try {{
              await navigator.clipboard.writeText(rawUrl);
            }} catch {{
              // Clipboard can be blocked by browser policy; the deep link still remains the primary action.
            }}
          }}
          ...
          window.setTimeout(() => {{
            if (document.visibilityState === 'visible') {{
              setStatus(`\u0415\u0441\u043b\u0438 ${{client}} \u043d\u0435 \u043e\u0442\u043a\u0440\u044b\u043b\u0441\u044f, raw URL \u0443\u0436\u0435 \u0441\u043a\u043e\u043f\u0438\u0440\u043e\u0432\u0430\u043d. \u0415\u0433\u043e \u043c\u043e\u0436\u043d\u043e \u0432\u0441\u0442\u0430\u0432\u0438\u0442\u044c \u0432 \u0438\u043c\u043f\u043e\u0440\u0442 \u0432\u0440\u0443\u0447\u043d\u0443\u044e \u0438\u043b\u0438 \u043e\u0442\u0441\u043a\u0430\u043d\u0438\u0440\u0443\u0439\u0442\u0435 QR.`, 'fallback');
            }}
          }}, 1600);
        }});
      }});
