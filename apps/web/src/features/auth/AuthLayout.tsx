    ...
    <main className="auth-shell">
      <section className="auth-intro" aria-label="Lumen Guard overview">
        ...
        <div>
          ...
          <h1>Lumen Guard</h1>
          <p>
            A quiet control surface for operators: authenticate, confirm MFA, then enter the
            portal with least-privilege defaults.
          </p>
        </div>
        <div className="auth-intro__status">
          <StatusBadge tone="good">MFA required</StatusBadge>
