...
const ru: Record<string, string> = {
  ...
  'Backend render status not exposed': 'Backend не отдает статус рендера',
  ...
  'Backend does not expose subscription request history for this user.':
    'Backend не отдает историю запросов подписки для этого пользователя.',
